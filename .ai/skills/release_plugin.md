...
This skill outlines the standard operating procedure for releasing a new version of the **NHR Hide Admin Notice** plugin.

## Versioning Definitions
- **Major Release**: Increment the second digit (0.1.0 bump). Example: `1.1.0` -> `1.2.0`.
- **Minor Release**: Increment the third digit (0.0.1 bump). Example: `1.1.0` -> `1.1.1`.
...
1. **Main Plugin File**: Update the `Version:` header in `nhrrob-hide-admin-notice.php`.
2. **Readme File**: 
...
1. Commit the version bump:
   ```bash
   git add nhrrob-hide-admin-notice.php readme.txt
